...
import torch
from utils.graphs import laplacian_embeddings, random_walk_embeddings, degree_matrix
...
from benchmark_embedding import GCN
from utils.misc import collate, get_device
...
def add_features(G, feat: str = 'degree', dim: int = 2):
    ...
    G.ndata['node_attr'] = torch.FloatTensor(attributes.copy())
